...
export default function Research() {
  ...
  const handleChallenge2Change = (e) => {
    const { value, checked } = e.target;
    setChallenges2(prev => {
      if (checked) {
        if (prev.length < 3) {
        ...
        <div className="bg-white bg-opacity-20 p-8 rounded-lg shadow-lg w-full max-w-2xl">
          <form className="text-white" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <select
                className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 text-gray-700"
                value={womenLeadership}
                onChange={e => setWomenLeadership(e.target.value)}
              >
                <option value="">Select an option</option>
                <option value="yes">Yes</option>
                <option value="no">No</option>
            ...
            <div className="mb-6">
              ...
              <select
                className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 text-gray-700"
                value={web3Funding}
                onChange={e => setWeb3Funding(e.target.value)}
              >
                <option value="">Select an option</option>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-2">
                <label className="flex items-center">
                  <input type="checkbox" value="capital" checked={challenges.includes('capital')} onChange={e => handleChallengeChange(e)} className="mr-2" />
                  Access to capital or investors
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="team" checked={challenges.includes('team')} onChange={e => handleChallengeChange(e)} className="mr-2" />
                  Building a trustworthy team
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="ecosystem" checked={challenges.includes('ecosystem')} onChange={e => handleChallengeChange(e)} className="mr-2" />
                  Understanding the ecosystem / lack of information
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="community" checked={challenges.includes('community')} onChange={e => handleChallengeChange(e)} className="mr-2" />
                  Lack of community or support network
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="scaling" checked={challenges.includes('scaling')} onChange={e => handleChallengeChange(e)} className="mr-2" />
                  Scaling the project
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="other" checked={challenges.includes('other')} onChange={e => handleChallengeChange(e)} className="mr-2" />
                  Other (please specify)
                </label>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-2">
                <label className="flex items-center">
                  <input type="checkbox" value="training" checked={opportunities.includes('training')} onChange={e => handleOpportunityChange(e)} className="mr-2" />
                  Technical training
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="mentorship" checked={opportunities.includes('mentorship')} onChange={e => handleOpportunityChange(e)} className="mr-2" />
                  Access to mentorship
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="funding" checked={opportunities.includes('funding')} onChange={e => handleOpportunityChange(e)} className="mr-2" />
                  Funding
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="networking" checked={opportunities.includes('networking')} onChange={e => handleOpportunityChange(e)} className="mr-2" />
                  International networking
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="visibility" checked={opportunities.includes('visibility')} onChange={e => handleOpportunityChange(e)} className="mr-2" />
                  Project visibility
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="jobs" checked={opportunities.includes('jobs')} onChange={e => handleOpportunityChange(e)} className="mr-2" />
                  Hiring / job opportunities
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="other" checked={opportunities.includes('other')} onChange={e => handleOpportunityChange(e)} className="mr-2" />
                  Other (please specify)
                </label>
                {opportunities.includes('other') && (
                  <input
                    type="text"
                    className="mt-2 shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 placeholder-gray-500"
                    placeholder="Please specify your opportunity"
            ...
            <div className="mb-6">
              ...
              <select
                className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 text-gray-700 mb-2"
                value={country}
              ...
              <input
                type="text"
                className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 placeholder-gray-500"
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-2">
                <label className="flex items-center">
                  <input type="checkbox" value="info" checked={challenges2.includes('info')} onChange={e => handleChallenge2Change(e)} className="mr-2" />
                  Lack of information or technical barriers
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="networks" checked={challenges2.includes('networks')} onChange={e => handleChallenge2Change(e)} className="mr-2" />
                  Limited access to networks or communities
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="funding" checked={challenges2.includes('funding')} onChange={e => handleChallenge2Change(e)} className="mr-2" />
                  Difficulty obtaining funding
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="visibility" checked={challenges2.includes('visibility')} onChange={e => handleChallenge2Change(e)} className="mr-2" />
                  Lack of visibility or platforms to showcase my work
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="opportunities" checked={challenges2.includes('opportunities')} onChange={e => handleChallenge2Change(e)} className="mr-2" />
                  Unequal opportunities within teams
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="personal" checked={challenges2.includes('personal')} onChange={e => handleChallenge2Change(e)} className="mr-2" />
                  Personal responsibilities or limited time to dedicate to the ecosystem
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="other" checked={challenges2.includes('other')} onChange={e => handleChallenge2Change(e)} className="mr-2" />
                  Other (please specify)
                </label>
                {challenges2.includes('other') && (
                  <input
                    ...
                    className="mt-2 shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 placeholder-gray-500"
                    placeholder="Please specify your challenge"
                    value={challenges2Other}
                    onChange={e => setChallenges2Other(e.target.value)}
                  />
                )}
              </div>
            </div>
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-2">
                <label className="flex items-center">
                  <input type="checkbox" value="language" checked={barriers.includes('language')} onChange={e => handleBarriersChange(e)} className="mr-2" />
                  Language (most content is in English)
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="curve" checked={barriers.includes('curve')} onChange={e => handleBarriersChange(e)} className="mr-2" />
                  Very steep learning curve
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="programs" checked={barriers.includes('programs')} onChange={e => handleBarriersChange(e)} className="mr-2" />
                  Lack of free or well-structured programs
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="mentors" checked={barriers.includes('mentors')} onChange={e => handleBarriersChange(e)} className="mr-2" />
                  Lack of guidance or mentors
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="validation" checked={barriers.includes('validation')} onChange={e => handleBarriersChange(e)} className="mr-2" />
                  Not knowing how to validate if what I'm learning is useful
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="other" checked={barriers.includes('other')} onChange={e => handleBarriersChange(e)} className="mr-2" />
                  Other (please specify)
                </label>
                {barriers.includes('other') && (
                  <input
                    type="text"
                    className="mt-2 shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 placeholder-gray-500"
                    placeholder="Please specify your barrier"
                    value={barriersOther}
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-2">
                <label className="flex items-center">
                  <input type="checkbox" value="funding" checked={missing.includes('funding')} onChange={e => handleMissingChange(e)} className="mr-2" />
                  Accessible funding
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="mentors" checked={missing.includes('mentors')} onChange={e => handleMissingChange(e)} className="mr-2" />
                  Experienced mentors
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="education" checked={missing.includes('education')} onChange={e => handleMissingChange(e)} className="mr-2" />
                  Clear and local educational content
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="networks" checked={missing.includes('networks')} onChange={e => handleMissingChange(e)} className="mr-2" />
                  Connections and support networks
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="visibility" checked={missing.includes('visibility')} onChange={e => handleMissingChange(e)} className="mr-2" />
                  Visibility and outreach
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="legal" checked={missing.includes('legal')} onChange={e => handleMissingChange(e)} className="mr-2" />
                  Legal clarity and regulatory framework
                </label>
                <label className="flex items-center">
                  <input type="checkbox" value="other" checked={missing.includes('other')} onChange={e => handleMissingChange(e)} className="mr-2" />
                  Other (please specify)
                </label>
                {missing.includes('other') && (
                  <input
                    type="text"
                    className="mt-2 shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-pink-200 placeholder-gray-500"
                    placeholder="Please specify what is missing"
                    value={missingOther}
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-2">
                <label className="flex items-center">
                  <input type="radio" name="negativeExp" value="several" checked={negativeExp === 'several'} onChange={e => setNegativeExp(e.target.value)} className="mr-2" />
                  Yes, several times
                </label>
                <label className="flex items-center">
                  <input type="radio" name="negativeExp" value="once" checked={negativeExp === 'once'} onChange={e => setNegativeExp(e.target.value)} className="mr-2" />
                  Yes, once
                </label>
                <label className="flex items-center">
                  <input type="radio" name="negativeExp" value="no" checked={negativeExp === 'no'} onChange={e => setNegativeExp(e.target.value)} className="mr-2" />
                  No
                </label>
                <label className="flex items-center">
                  <input type="radio" name="negativeExp" value="prefer_not" checked={negativeExp === 'prefer_not'} onChange={e => setNegativeExp(e.target.value)} className="mr-2" />
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-col space-y-2">
                <label className="flex items-center">
                  <input type="radio" name="futureContact" value="yes" checked={futureContact === 'yes'} onChange={e => setFutureContact(e.target.value)} className="mr-2" />
                  Yes
                </label>
                <label className="flex items-center">
                  <input type="radio" name="futureContact" value="no" checked={futureContact === 'no'} onChange={e => setFutureContact(e.target.value)} className="mr-2" />
                  No
                </label>
                {futureContact === 'yes' && (
                  <input
                    ...
                    value={futureContactValue}
                    onChange={e => setFutureContactValue(e.target.value)}
                  />
                )}
              </div>
            </div>
